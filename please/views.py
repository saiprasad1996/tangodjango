...
def postquestion(request):
    if request.method == "GET":
        ...
        try : 
            ...
            new_data.save()
            r = requests.post('https://hooks.slack.com/services/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', json = {"text":"Question from {} : {}".format(user_name,text)},headers={"Content-Type":"application/json"})
            response = {
